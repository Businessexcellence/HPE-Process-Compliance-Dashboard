  ...
  <div class="tab-content" id="tab-data">
    ...
    <div class="upload-zone" id="uploadZone" onclick="document.getElementById('fileInput').click()" 
      ...
      <div class="upload-subtitle">Supports .xlsx, .xls, .csv formats — Max 50MB<br>
        <strong>Required sheets:</strong> "Parameter Data" + "Recruiter Data"
      </div>
    </div>
    ...
    <div class="chart-grid-2">
      <div class="card">
        ...
        <div class="validation-item">
          ...
          <div class="val-text"><strong>Parameter data sheet:</strong> 319 rows loaded successfully</div>
        </div>
        <div class="validation-item">
          <span class="val-icon" style="color:var(--hpe-green)">✅</span>
          <div class="val-text"><strong>Recruiter data sheet:</strong> 8,600 rows loaded successfully</div>
        </div>
        <div class="validation-item">
          <span class="val-icon" style="color:var(--hpe-green)">✅</span>
      ...
      <div class="card">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:8px">
          ...
          <div style="background:#fffbe6;padding:14px;border-radius:8px;text-align:center;grid-column:span 2">
...
function navigateToTab(tabName) {
  var navBtn = document.querySelector('.nav-tab[onclick*="switchTab(\'"+tabName+"\'"]');
  if (!navBtn) {
    // Try finding by partial match
    var allTabs = document.querySelectorAll('.nav-tab');
    for (var i = 0; i < allTabs.length; i++) {
      if (allTabs[i].getAttribute('onclick') && allTabs[i].getAttribute('onclick').indexOf("'"+tabName+"'") !== -1) {
        navBtn = allTabs[i];
        break;
      }
    }
...
function initSLATrendCharts() {
  ...
  if (classEl) {
    const classify = (mi) => {
      ...
      const r24 = fy25d.length ? fy25d.filter(s=>s==='MET').length/fy25d.length : 0;
